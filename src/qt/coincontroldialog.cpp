...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    QString toolTip3 = tr("This label turns red if any recipient receives an amount smaller than %1.").arg(InfinitumUnits::formatHtmlWithUnit(nDisplayUnit, ::minRelayTxFee.GetFee(546)));
